...
If you are using TypeScript in your frontend and [registering typed events](#typed-events-with-type-safety) in your Go code, you will get event name autocomplete/checking and data type checking.
