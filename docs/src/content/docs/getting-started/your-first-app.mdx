...
5.  ## Packaging Your Application
    ...
    <TabItem label="Mac" icon="apple">
        ...
        check out our [Installers & Packaging guide](/guides/installers).
...
If you are a more advanced user, check out our [Guides](/guides/dev/project-structure) for more detailed information on how to use Wails.
